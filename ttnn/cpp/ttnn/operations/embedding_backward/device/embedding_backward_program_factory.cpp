...
tt::tt_metal::ProgramDescriptor EmbeddingBackwardProgramFactory::create_descriptor(
    ...
    uint32_t offset = 0;
    for (auto core : cores) {
        uint32_t tiles_in_row = core_group_1.contains(core) ? num_tiles_per_core_group_1 : num_tiles_per_core_group_2;
        reader_desc.emplace_runtime_args(
            ...
            {grad_tensor_buffer,
             ...
             tiles_in_row});   // how many tiles to process in a row
        compute_desc.emplace_runtime_args(core, {tiles_in_row});
