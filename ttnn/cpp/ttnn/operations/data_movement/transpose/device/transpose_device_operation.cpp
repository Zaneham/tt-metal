...
using ttnn::operations::data_movement::transpose::derive_effective_output_memory_config;
using ttnn::operations::data_movement::transpose::is_native_transpose_sharding;
using ttnn::operations::data_movement::transpose::transposed_shapes;
...
TransposeDeviceOperation::program_factory_t TransposeDeviceOperation::select_program_factory(
    ...
    const auto output_memory_config = derive_effective_output_memory_config(
        input_tensor, operation_attributes.dim, operation_attributes.output_mem_config);
...
TensorSpec TransposeDeviceOperation::compute_output_specs(
    const operation_attributes_t& operation_attributes, const tensor_args_t& tensor_args) {
    const auto& input_tensor = tensor_args.input;
    const auto output_mem_config = derive_effective_output_memory_config(
        input_tensor, operation_attributes.dim, operation_attributes.output_mem_config);
