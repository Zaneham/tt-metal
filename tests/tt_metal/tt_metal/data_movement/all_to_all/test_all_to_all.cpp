    ...
    */
    ...
    if (test_config.use_2_0_api) {
        ...
        KernelSpec sender_spec{
            .unique_id = "sender",
            .source =
                KernelSpec::SourceFilePath{"tests/tt_metal/tt_metal/data_movement/all_to_all/kernels/sender_2_0.cpp"},
            .num_threads = 1,
        ...
        for (auto& mst_logical_core : corerange_to_cores(mst_logical_core_set)) {
            ...
            varargs.push_back((uint32_t)test_config.num_of_transactions_per_master);
