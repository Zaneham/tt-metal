...
void kernel_main() {
    ...
    constexpr uint32_t bytes_per_transaction = get_arg(args::bytes_per_tx);
    constexpr uint32_t test_id = get_arg(args::test_id);
    constexpr uint32_t packed_subordinate_core_coordinates = get_arg(args::sub_coords);
    constexpr uint32_t pcie_l1_local_addr = get_arg(args::pcie_l1_addr);
    constexpr uint32_t l1_local_addr = get_arg(args::l1_addr);
    constexpr uint32_t clock_freq_mhz = get_arg(args::clock_freq_mhz);
