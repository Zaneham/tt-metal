...
#include "sfpu/ckernel_sfpu_add.h"  // _calculate_add_

namespace ckernel {

inline void llk_math_eltwise_binary_sfpu_add_int_init() { _llk_math_eltwise_binary_sfpu_init_(); }
...
inline void llk_math_eltwise_binary_sfpu_add_int(
    ...
    _llk_math_eltwise_binary_sfpu_params_<APPROXIMATE>(
        ckernel::sfpu::_calculate_add_, 0, DATA_FORMAT, ITERATIONS, in0_offset, in1_offset, out_offset);
}
