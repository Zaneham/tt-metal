...
#pragma GCC unroll 8
    for (int d = 0; d < ITERATIONS; d++)
    {
        ...
        /*
        TTI_SFPLOADI(p_sfpu::LREG1, sfpi::SFPLOADI_MOD0_FLOATB, 0x007F);
        TTI_SFPLOADI(p_sfpu::LREG2, sfpi::SFPLOADI_MOD0_FLOATB, 0x7F80);

        TTI_SFPAND(0, p_sfpu::LREG0, p_sfpu::LREG1, 0);
        TTI_SFPSHFT(8, p_sfpu::LREG0, p_sfpu::LREG1, 1);

        TTI_SFPAND(0, p_sfpu::LREG0, p_sfpu::LREG2, 0);
        TTI_SFPSHFT((-7) & 0xfff, p_sfpu::LREG0, p_sfpu::LREG2, 1);

        TTI_SFPOR(0, p_sfpu::LREG1, p_sfpu::LREG2, 0);
        TTI_SFPSETSGN(0, p_sfpu::LREG2, p_sfpu::LREG0, 0);

        TTI_SFPSHFT((-16) & 0xfff, p_sfpu::LREG0, p_sfpu::LREG0, 1);
        */
